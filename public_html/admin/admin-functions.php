...
function landing_section_configs(): array
{
    return [
        ...
        'projects' => ['label' => 'نمونه‌کارها', 'icon' => 'bi-kanban', 'fields' => ['title', 'description', 'image', 'tags', 'button_text', 'link']],
...
{
    $base = ['id' => 'item-' . ($index + 1), 'title' => '', 'description' => '', 'icon' => '', 'image' => '', 'link' => '', 'button_text' => '', 'tags' => [], 'lessons' => [], 'duration' => '', 'subtitle' => '', 'rating' => '', 'category' => '', 'sort_order' => $index + 1, 'status' => 'active'];
